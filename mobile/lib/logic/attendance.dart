...
/// Where the percentage lands after [futurePresent] more classes attended and
/// [futureAbsent] more missed.
///
/// A projection, never a record: nothing here is written anywhere, and the
/// figure is what *would* happen rather than what has. Ported from
/// calculateProjectedAttendance in the web's attendance.ts.
double? projectedAfter(int attended, int held, int futurePresent, [int futureAbsent = 0]) =>
    calculateAttendance(attended + futurePresent, held + futurePresent + futureAbsent);
