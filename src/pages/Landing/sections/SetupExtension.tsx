      ...
      <div className={styles.inner}>
        <div className={styles.setupHead}>
          <div className={styles.narrow}>
            ...
            <p className={styles.lede} data-reveal style={delay(0.1)}>
              This is the piece that reads your data out of Campus Connect and creates your account.
              It runs in Chrome or Edge on a laptop or desktop — you only need to do this once, and
              you can do it on any machine you use.
            </p>
          </div>

          <div className={styles.downloadCard} data-reveal style={delay(0.14)}>
            <div className={styles.downloadMeta}>
              <span className={styles.downloadMetaName}>Handy College Sync v{EXTENSION.version}</span>
              Chrome · Edge · Brave
              <br />
        ...
        <div className={styles.setupSteps}>
          <div className={styles.setupStep} data-reveal>
            ...
            <div>
              ...
              <p className={styles.setupBody}>
                Unzip it somewhere permanent — your Documents folder, not Downloads. Chrome loads the
                extension from this folder every time it starts, so moving or deleting it later
          ...
          <div className={styles.setupStep} data-reveal>
            ...
            <div>
              ...
              <p className={styles.setupBody}>
                Click <span className={styles.kbd}>Load unpacked</span> and select the unzipped folder
                — the one containing <span className={styles.kbd}>manifest.json</span>, not its
                parent. Handy College Sync appears in the list. Pin it to the toolbar so you can see
                its badge.
              </p>
            </div>
          </div>
          ...
          <div className={styles.setupStep} data-reveal>
            ...
            <div>
              ...
              <p className={styles.setupBody}>
                Open <a href={LINKS.portal}>info.aec.edu.in/aus</a> and sign in exactly as you always
                do — the extension takes no part in this, and never sees what you type.
              </p>
            </div>
          </div>
          ...
          <div className={styles.setupStep} data-reveal>
            ...
            <div>
              ...
              <p className={styles.setupBody}>
                ...
                percentages on it. That single page is all the extension needs. Give it a few seconds:
                the badge turns into a green check when your data has synced.
              </p>
            </div>
          </div>
          ...
          <div className={styles.setupStep} data-reveal>
            ...
            <div>
              ...
              <p className={styles.setupBody}>
                Your account now exists. Use your roll number on <a href={LINKS.webApp}>the web app</a>{" "}
                or in the Android app. Every future visit to your profile page refreshes the data on
                its own — you never have to come back here.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className={styles.note} data-reveal>
          <div className={styles.noteTitle}>
            <span aria-hidden="true">💡</span> Things that look wrong but are not
          </div>
          <ul className={styles.noteList}>
            ...
            <li>
              ...
              after you have changed your Handy password on another device. Signing in once in the web
              app hands the new credential back to the extension and syncing resumes on its own.
            </li>
            <li>
              <strong>Nothing captured after a couple of minutes.</strong> Make sure you are on the
              profile page with your attendance visible, then reload it. Reloading the extension from{" "}
              <span className={styles.kbd}>chrome://extensions</span> and revisiting the page fixes
        ...
        <div className={`${styles.note} ${styles.noteWarn}`} data-reveal>
          <div className={styles.noteTitle}>
            <span aria-hidden="true">⚠️</span> Worth knowing before you start
          </div>
          <ul className={styles.noteList}>
            <li>
